                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.blog.index') }}">{{ __('Main') }}</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="{{ route('admin.posts.edit', $post->id) }}"><i class="fas fa-edit fa-lg mx-2" style="color: #f4c01a"></i></a>
